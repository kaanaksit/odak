...
def test_ray_intersect_w_a_triangle():
    ray_start_point_0 = [5.0, 5.0, 0.0]
    ray_end_point_0 = [10.0, 10.0, 1000.0]
    ray_0 = odak.raytracing.create_ray_from_two_points(
        ray_start_point_0, ray_end_point_0
    )
    ray_start_point_1 = [5.0, 5.0, 0.0]
    ray_end_point_1 = [0.0, 100.0, 1000.0]
    ray_1 = odak.raytracing.create_ray_from_two_points(
        ray_start_point_1, ray_end_point_1
    )
    triangle = [
        [50.0, 50.0, 1000.0],
        [-5.0, -5.0, 1000.0],
