...
def test():
    sample_entry_points = grid_sample(
        no=[2, 2], size=[100.0, 100.0], center=[0.0, 0.0, 0.0], angles=[0.0, 0.0, 0.0]
    )
    ...
    rays = raytracer.create_ray_from_two_points(sample_entry_points, sample_exit_points)
    diffuser = catalog.diffusers.thin_diffuser(
        shape=[50, 50],
        center=[0.0, 0.0, 100.0],
        angles=[0.0, 0.0, 0.0],
        diffusion_no=[5, 2],
        diffusion_angle=10.0,
    )
