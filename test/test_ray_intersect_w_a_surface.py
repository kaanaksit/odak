...
def test_ray_intersect_w_a_surface():
    ray_start_point = [5.0, 5.0, 0.0]
    ray_end_point = [0.0, 0.0, 1000.0]
    ray = odak.raytracing.create_ray_from_two_points(ray_start_point, ray_end_point)
    surface_center = [0.0, 0.0, 1000.0]
