...
def test():
    ...
    linear_rgb_image = odak.learn.perception.color_conversion.rgb_to_linear_rgb(
        rgb_image
    )
    rgb_image = odak.learn.perception.color_conversion.linear_rgb_to_rgb(
        linear_rgb_image
    )

    xyz_image = odak.learn.perception.color_conversion.linear_rgb_to_xyz(
        linear_rgb_image
    )
    linear_rgb_image = odak.learn.perception.color_conversion.xyz_to_linear_rgb(
        xyz_image
    )
