...
def test():
    ...
    pixel_pitch = 8e-6 # (2)
    distance = 0.5e-2 # (3)
    propagation_types = ['Angular Spectrum', 'Transfer Function Fresnel'] # (4)
    ...
    for propagation_type in propagation_types:
        ...
        odak.learn.tools.save_image(
                                    'image_intensity_'+'{}.png'.format(propagation_type.replace(' ', '_')), 
                                    image_intensity, 
                                    cmin = 0., 
                                    cmax = 1.
                                ) # (11)
        odak.learn.tools.save_image(
                                    'hologram_intensity_'+'{}.png'.format(propagation_type.replace(' ', '_')), 
                                    hologram_intensity, 
                                    cmin = 0., 
                                    cmax = 1.
                                ) # (12)
