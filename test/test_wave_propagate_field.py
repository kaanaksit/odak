...
def test():
    ...
    size1 = [10.0, 10.0]
    wavelength = 0.005
    surface_location_0 = [0.0, 0.0, 0.0]
    surface_location_1 = [0.0, 0.0, 10.0]
    wave_number = wave.wavenumber(wavelength)
    samples_surface_0 = tools.grid_sample(no=no0, size=size0, center=surface_location_0)
    samples_surface_1 = tools.grid_sample(no=no1, size=size1, center=surface_location_1)
