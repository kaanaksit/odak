...
Depending on the needs of scientists at all levels or professionals from the industry, these submodules can help design processes in optics and visual perception.

Odak includes modules for geometric [3D raytracing](https://github.com/kaanaksit/odak/tree/master/odak/raytracing/), [Jones calculus](https://github.com/kaanaksit/odak/tree/master/odak/jones), [wave optics](odak/wave.md), and [a set of tools](https://github.com/kaanaksit/odak/tree/master/odak/tools) to ease pain in [measurement](https://github.com/kaanaksit/odak/tree/master/odak/measurement), [exporting/importing CAD](https://github.com/kaanaksit/odak/tree/master/odak/tools/asset.py), and [visualization](https://github.com/kaanaksit/odak/tree/master/odak/visualize) during a design process.
We have generated a set of recipes that go well with machine learning approaches compatible with the PyTorch learning framework as provided [here](https://github.com/kaanaksit/odak/tree/master/odak/learn).
We have created many [test scripts](https://github.com/kaanaksit/odak/tree/master/test/) to inspire how you use Odak and help your design process.
Finally, we have created a [distribution system](https://github.com/kaanaksit/odak/tree/master/odak/manager) to process tasks in parallel across multiple computing resources within the same network.
Odak can either run using CPUs or automatically switch to [NVIDIA GPUs](https://github.com/kaanaksit/odak/tree/master/odak/__init__.py#L8).
...
All of this led to an exciting never-ending excursion that I still enjoy to this day, which I named Odak.
...
I used Odak in all my published papers.
When I look back, I can only say that I am thankful to 2011 me spending part of his summer in front of a computer coding a raytracer for optical design.
...
Odak keeps on growing [thanks to a body of people who contributed over time](https://github.com/kaanaksit/odak/blob/master/THANKS.txt).
